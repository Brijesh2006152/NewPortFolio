...
function App() {
  ...
  const C_programming = ["ANSI C fundamentals", "Variables, loops, functions, arrays, and recursion", "Debugging and error-handling practice ", "Strong focus on low-level programming logic and code understanding."]
  {
    ...
    /*
    let skills_content = [
      "HTML5, CSS3, JavaScript | Responsive design and mobile-friendly layouts | React fundamentals and component-based UI development | Clean structure, simple user interface design, and best coding practices.",    "Python scripting and automation | Problem-solving with Python | GUI development basics with Tkinter | Writing readable, efficient, and practical code",
